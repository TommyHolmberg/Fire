...
widthBypassButton4(std::make_unique<juce::ToggleButton>())
{
    ...
    shapePanelLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    compressorPanelLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    widthPanelLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    driveLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    outputLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    CompRatioLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    CompThreshLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    widthLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    biasLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    recLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    mixLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
