...
GlobalPanel::GlobalPanel(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    postFilterPanelLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    downSamplePanelLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    outputLabelGlobal.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    mixLabelGlobal.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    downSampleLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
...
//    limiterReleaseLabel.setJustificationType (juce::Justification::centred);
    ...
    lowcutFreqLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    lowcutGainLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    lowcutQLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    highcutFreqLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    highcutGainLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    highcutQLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    peakFreqLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    peakQLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    peakGainLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
...
//    filterStateLabel.setJustificationType (juce::Justification::centred);
    ...
    filterTypeLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    lowcutSlopeLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
    ...
    highcutSlopeLabel.setFont(FontManager::getKnobFont(KNOB_FONT_SIZE));
